  ...
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" @submit.prevent="handleLogin">
        ...
        <div>
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm">
              <a href="#" class="font-semibold text-indigo-400 hover:text-indigo-300">パスワードをお忘れですか？</a>
            </div>
          </div>
          <div class="mt-2">
            <input
      ...
      <p class="mt-10 text-center text-sm text-gray-400">
        アカウントをお持ちでないですか？
        {{ ' ' }}
        <router-link to="/signup" class="font-semibold leading-6 text-indigo-400 hover:text-indigo-300">新規登録はこちら</router-link>
      </p>
    </div>
  </div>
</template>
